...
@step('I press the element with xpath "{xpath}"')
@persona_vars
...
def set_html_content_to_element_with_id(context, id, contents):
    assert context.browser.evaluate_script("document.getElementById('%s').innerHTML = '%s'" % (id, contents)), 'Element not found or could not set HTML content'
...
def set_html_content_to_element_with_class(context, klass, contents):
    assert context.browser.evaluate_script("document.getElementsByClassName('%s')[0].innerHTML = '%s'" % (klass, contents)), 'Element not found or could not set HTML content'


@step('field "{name}" should have the value "{value}"')
@persona_vars
...
@step('"{name}" should be disabled')
@step('"{name}" should not be enabled')
@persona_vars
...
@step('field "{name}" should be valid')
@persona_vars
...
@step('field "{name}" should be invalid')
@step('field "{name}" should not be valid')
@persona_vars
...
@step('field "{name}" should be required')
@persona_vars
...
@step('field "{name}" should not be required')
@persona_vars
