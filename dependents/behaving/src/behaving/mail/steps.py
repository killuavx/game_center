...
@step('I should receive an email at "{address}" containing "{text}"')
@persona_vars
...
@step('I should receive an email at "{address}" with subject "{subject}"')
@persona_vars
