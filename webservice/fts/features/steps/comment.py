...
@when('I post comment "{content:emptys}" to the package')
def step_post_comment_to_the_package(context, content):
    ApiDSL.When_i_post_comment_to(context, content, context.package)
