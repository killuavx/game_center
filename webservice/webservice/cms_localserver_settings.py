...
STATIC_URL = 'http://android.ccplay.com.cn:8000/%s/' % STATIC_URL.strip('/')
#STATIC_URL = 'http://gc.ccplay.com.cn/%s/'% STATIC_URL.strip('/')

#OST_URL = os.getenv('GC_HOST_URL', 'http://gc.ccplay.com.cn')
#EDIA_URL = 'http://0.0.0.0:8080/%s/' % MEDIA_URL.strip('/')
#TATIC_URL = 'http://0.0.0.0:8080/%s/'% STATIC_URL.strip('/')
