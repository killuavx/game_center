...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'GiftBag', fields ['site', 'status', 'publish_date']
        db.create_index('activity_giftbag', ['site_id', 'status', 'publish_date'])

        # Adding index on 'GiftBag', fields ['site', 'status', 'for_package', 'for_version', 'publish_date']
        db.create_index('activity_giftbag', ['site_id', 'status', 'for_package_id', 'for_version_id', 'publish_date'])

        # Adding index on 'GiftBag', fields ['site', 'status', 'for_package', 'publish_date']
        db.create_index('activity_giftbag', ['site_id', 'status', 'for_package_id', 'publish_date'])


    def backwards(self, orm):
        # Removing index on 'GiftBag', fields ['site', 'status', 'for_package', 'publish_date']
        db.delete_index('activity_giftbag', ['site_id', 'status', 'for_package_id', 'publish_date'])

        # Removing index on 'GiftBag', fields ['site', 'status', 'for_package', 'for_version', 'publish_date']
        db.delete_index('activity_giftbag', ['site_id', 'status', 'for_package_id', 'for_version_id', 'publish_date'])

        # Removing index on 'GiftBag', fields ['site', 'status', 'publish_date']
        db.delete_index('activity_giftbag', ['site_id', 'status', 'publish_date'])
    ...
    models = {
        ...
        'activity.giftcard': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['account.User']", 'on_delete': 'models.DO_NOTHING', 'blank': 'True', 'null': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
        ...
        'toolkit.star': {
            ...
            'by_comment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['generic.ThreadedComment']", 'blank': 'True', 'on_delete': 'models.DO_NOTHING', 'null': 'True', 'default': 'None', 'related_name': "'content_star'"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'related_name': "'+'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'blank': 'True', 'null': 'True', 'max_length': '15'}),
            'object_pk': ('django.db.models.fields.IntegerField', [], {}),
            'rating_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True', 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['account.User']", 'blank': 'True', 'on_delete': 'models.DO_NOTHING', 'null': 'True', 'default': 'True', 'related_name': "'stars'"}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
        'warehouse.author': {
        ...
        'warehouse.packageversion': {
            ...
            'di_download_md5': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'default': 'None', 'max_length': '40'}),
            ...
            'download_md5': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'default': 'None', 'max_length': '40'}),
