...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.workspace'
        db.add_column('warehouse_packageversion', 'workspace',
                      self.gf('mezzanine.core.fields.FileField')(max_length=500, default='', blank=True),
                      keep_default=False)

        # Adding field 'Package.workspace'
        db.add_column('warehouse_package', 'workspace',
                      self.gf('mezzanine.core.fields.FileField')(max_length=500, default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersion.workspace'
        db.delete_column('warehouse_packageversion', 'workspace')

        # Deleting field 'Package.workspace'
        db.delete_column('warehouse_package', 'workspace')
    ...
    models = {
        ...
        'warehouse.package': {
            ...
            'workspace': ('mezzanine.core.fields.FileField', [], {'max_length': '500', 'default': 'None', 'blank': 'True'})
        },
