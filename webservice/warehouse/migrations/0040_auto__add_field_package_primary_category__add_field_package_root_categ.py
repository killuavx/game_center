...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.primary_category'
        db.add_column('warehouse_package', 'primary_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['taxonomy.Category'], related_name='primary_packages', null=True),
                      keep_default=False)

        # Adding field 'Package.root_category'
        db.add_column('warehouse_package', 'root_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['taxonomy.Category'], related_name='root_packages', null=True),
                      keep_default=False)


        # Changing field 'Package.tags_text'
        #db.alter_column('warehouse_package', 'tags_text', self.gf('toolkit.fields.TagField')())

        # Changing field 'PackageVersion.tags_text'
        #db.alter_column('warehouse_packageversion', 'tags_text', self.gf('toolkit.fields.TagField')())

    def backwards(self, orm):
        # Deleting field 'Package.primary_category'
        db.delete_column('warehouse_package', 'primary_category_id')

        # Deleting field 'Package.root_category'
        db.delete_column('warehouse_package', 'root_category_id')


        # Changing field 'Package.tags_text'
        #db.alter_column('warehouse_package', 'tags_text', self.gf('tagging_autocomplete.models.TagAutocompleteField')())

        # Changing field 'PackageVersion.tags_text'
        #db.alter_column('warehouse_packageversion', 'tags_text', self.gf('tagging_autocomplete.models.TagAutocompleteField')())
    ...
    models = {
        ...
        'taxonomy.topicalitem': {
            'Meta': {'ordering': "('ordering',)", 'object_name': 'TopicalItem', 'unique_together': "(('topic', 'content_type', 'object_id'),)", 'index_together': "(('site', 'topic'), ('site', 'topic', 'content_type'), ('site', 'topic', 'content_type', 'object_id'), ('site', 'topic', 'content_type', 'object_id', 'ordering'), ('topic', 'content_type'))"},
        ...
        'toolkit.resource': {
            'Meta': {'ordering': "('site', 'content_type', 'object_pk', 'kind')", 'object_name': 'Resource', 'unique_together': "(('site', 'content_type', 'object_pk', 'kind', 'alias'),)", 'index_together': "(('site', 'content_type'), ('site', 'content_type', 'object_pk'), ('site', 'content_type', 'object_pk', 'kind'))", 'db_table': "'common_resource'"},
        ...
        'toolkit.star': {
            ...
            'by_comment': ('django.db.models.fields.related.ForeignKey', [], {'on_delete': 'models.DO_NOTHING', 'to': "orm['generic.ThreadedComment']", 'default': 'None', 'blank': 'True', 'related_name': "'content_star'", 'null': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'related_name': "'+'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'blank': 'True', 'max_length': '15', 'null': 'True'}),
            'object_pk': ('django.db.models.fields.IntegerField', [], {}),
            'rating_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True', 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'on_delete': 'models.DO_NOTHING', 'to': "orm['account.User']", 'default': 'True', 'blank': 'True', 'related_name': "'stars'", 'null': 'True'}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
        'warehouse.author': {
        ...
        'warehouse.package': {
            ...
            'primary_category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['taxonomy.Category']", 'related_name': "'primary_packages'", 'null': 'True'}),
            'released_datetime': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'null': 'True', 'db_index': 'True'}),
            'root_category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['taxonomy.Category']", 'related_name': "'root_packages'", 'null': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
            'status': ('model_utils.fields.StatusField', [], {'default': "'draft'", 'max_length': '100', 'no_check_for_status': 'True'}),
            'summary': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "''", 'max_length': '255'}),
