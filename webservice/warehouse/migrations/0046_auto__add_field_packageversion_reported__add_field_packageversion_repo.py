...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.reported'
        db.add_column('warehouse_packageversion', 'reported',
                      self.gf('warehouse.models.PkgReportField')(default=False),
                      keep_default=False)

        # Adding field 'PackageVersion.reported_network'
        db.add_column('warehouse_packageversion', 'reported_network',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PackageVersion.reported_gplay'
        db.add_column('warehouse_packageversion', 'reported_gplay',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PackageVersion.reported_root'
        db.add_column('warehouse_packageversion', 'reported_root',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PackageVersion.reported_adv'
        db.add_column('warehouse_packageversion', 'reported_adv',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersion.reported'
        db.delete_column('warehouse_packageversion', 'reported')

        # Deleting field 'PackageVersion.reported_network'
        db.delete_column('warehouse_packageversion', 'reported_network')

        # Deleting field 'PackageVersion.reported_gplay'
        db.delete_column('warehouse_packageversion', 'reported_gplay')

        # Deleting field 'PackageVersion.reported_root'
        db.delete_column('warehouse_packageversion', 'reported_root')

        # Deleting field 'PackageVersion.reported_adv'
        db.delete_column('warehouse_packageversion', 'reported_adv')
    ...
    models = {
        ...
        'toolkit.star': {
            ...
            'by_comment': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['generic.ThreadedComment']", 'on_delete': 'models.DO_NOTHING', 'null': 'True', 'related_name': "'content_star'", 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'null': 'True', 'max_length': '15', 'blank': 'True'}),
            'object_pk': ('django.db.models.fields.IntegerField', [], {}),
            'rating_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'True', 'to': "orm['account.User']", 'on_delete': 'models.DO_NOTHING', 'null': 'True', 'related_name': "'stars'", 'blank': 'True'}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
        'warehouse.author': {
        ...
        'warehouse.packageversion': {
            'Meta': {'index_together': "(('site', 'package'), ('site', 'id'), ('site', 'status'), ('site', 'status', 'released_datetime'), ('has_award',), ('site', 'has_award'), ('site', 'award_coin'))", 'unique_together': "(('site', 'package', 'version_code'),)", 'object_name': 'PackageVersion'},
            'award_coin': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
