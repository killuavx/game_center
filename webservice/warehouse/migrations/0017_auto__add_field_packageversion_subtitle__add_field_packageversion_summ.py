...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.subtitle'
        db.add_column('warehouse_packageversion', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(max_length=128, default=''),
                      keep_default=False)

        # Adding field 'PackageVersion.summary'
        db.add_column('warehouse_packageversion', 'summary',
                      self.gf('django.db.models.fields.CharField')(max_length=255, default='', blank=True),
                      keep_default=False)

        # Adding field 'PackageVersion.description'
        db.add_column('warehouse_packageversion', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
        """
        for pv in orm.PackageVersion._default_manager.all():
            pv.description = pv.package.description
            pv.summary = pv.package.summary
            pv.save()
        """


    def backwards(self, orm):
        # Deleting field 'PackageVersion.subtitle'
        db.delete_column('warehouse_packageversion', 'subtitle')

        # Deleting field 'PackageVersion.summary'
        db.delete_column('warehouse_packageversion', 'summary')

        # Deleting field 'PackageVersion.description'
        db.delete_column('warehouse_packageversion', 'description')
