...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IOSPackageVersion.is_support_iphone'
        db.add_column('warehouse_iospackageversion', 'is_support_iphone',
                      self.gf('django.db.models.fields.BooleanField')(db_index=True, default=True),
                      keep_default=False)

        # Adding field 'IOSPackageVersion.is_support_ipad'
        db.add_column('warehouse_iospackageversion', 'is_support_ipad',
                      self.gf('django.db.models.fields.BooleanField')(db_index=True, default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IOSPackageVersion.is_support_iphone'
        db.delete_column('warehouse_iospackageversion', 'is_support_iphone')

        # Deleting field 'IOSPackageVersion.is_support_ipad'
        db.delete_column('warehouse_iospackageversion', 'is_support_ipad')
