...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'taxonomy.category': {
            ...
            'subtitle': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True', 'null': 'True', 'default': "''"}),
        ...
        'taxonomy.topicalitem': {
            'Meta': {'ordering': "('ordering',)", 'index_together': "(('topic', 'content_type'),)", 'unique_together': "(('topic', 'content_type', 'object_id'),)", 'object_name': 'TopicalItem'},
        ...
        'warehouse.packageversion': {
            ...
            'cover': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True', 'default': "''"}),
            'created_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'di_download': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True', 'default': "''"}),
            'download': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True', 'default': "''"}),
            'download_count': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '9', 'blank': 'True', 'default': '0'}),
            'icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True', 'default': "''"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
