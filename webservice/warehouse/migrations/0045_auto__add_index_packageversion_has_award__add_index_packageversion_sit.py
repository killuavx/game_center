...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PackageVersion', fields ['has_award']
        db.create_index('warehouse_packageversion', ['has_award'])

        # Adding index on 'PackageVersion', fields ['site', 'has_award']
        db.create_index('warehouse_packageversion', ['site_id', 'has_award'])

        # Adding index on 'PackageVersion', fields ['site', 'award_coin']
        db.create_index('warehouse_packageversion', ['site_id', 'award_coin'])


    def backwards(self, orm):
        # Removing index on 'PackageVersion', fields ['site', 'award_coin']
        db.delete_index('warehouse_packageversion', ['site_id', 'award_coin'])

        # Removing index on 'PackageVersion', fields ['site', 'has_award']
        db.delete_index('warehouse_packageversion', ['site_id', 'has_award'])

        # Removing index on 'PackageVersion', fields ['has_award']
        db.delete_index('warehouse_packageversion', ['has_award'])
    ...
    models = {
        ...
        'taxonomy.category': {
            ...
            'subtitle': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True', 'default': "''"}),
        ...
        'toolkit.star': {
            ...
            'by_comment': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'on_delete': 'models.DO_NOTHING', 'blank': 'True', 'to': "orm['generic.ThreadedComment']", 'default': 'None', 'related_name': "'content_star'"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'related_name': "'+'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'object_pk': ('django.db.models.fields.IntegerField', [], {}),
            'rating_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'on_delete': 'models.DO_NOTHING', 'blank': 'True', 'to': "orm['account.User']", 'default': 'True', 'related_name': "'stars'"}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
        'warehouse.author': {
        ...
        'warehouse.iosauthor': {
            ...
            'seller_name': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'seller_url': ('django.db.models.fields.URLField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'view_url': ('django.db.models.fields.URLField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'})
        },
        ...
        'warehouse.iospackageversion': {
            ...
            'appleformatted_rating': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True', 'default': 'None'}),
            'appleuser_rating': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True', 'default': 'None'}),
            'formatted_price': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'db_index': 'True', 'max_digits': '12', 'decimal_places': '3'}),
            'price_currency': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True', 'default': 'None'})
        },
        'warehouse.package': {
            ...
            'download_count': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '9', 'db_index': 'True', 'blank': 'True', 'default': '0'}),
        ...
        'warehouse.packageversion': {
            'Meta': {'index_together': "(('site', 'package'), ('site', 'id'), ('site', 'status'), ('site', 'status', 'released_datetime'), ('has_award',), ('site', 'has_award'), ('site', 'award_coin'))", 'object_name': 'PackageVersion', 'unique_together': "(('site', 'package', 'version_code'),)"},
            'award_coin': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'di_download_md5': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True', 'default': 'None'}),
            ...
            'download_md5': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True', 'default': 'None'}),
