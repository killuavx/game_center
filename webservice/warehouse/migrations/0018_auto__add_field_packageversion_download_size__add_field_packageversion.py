...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.download_size'
        db.add_column('warehouse_packageversion', 'download_size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.download_md5'
        db.add_column('warehouse_packageversion', 'download_md5',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=40, blank=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'PackageVersion.download_size'
        db.delete_column('warehouse_packageversion', 'download_size')

        # Deleting field 'PackageVersion.download_md5'
        db.delete_column('warehouse_packageversion', 'download_md5')


        # Changing field 'PackageVersion.download'
        db.alter_column('warehouse_packageversion', 'download', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'toolkit.star': {
            ...
            'by_comment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'content_star'", 'default': 'None', 'on_delete': 'models.DO_NOTHING', 'to': "orm['generic.ThreadedComment']"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'related_name': "'+'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'max_length': '15', 'blank': 'True', 'null': 'True'}),
            'object_pk': ('django.db.models.fields.IntegerField', [], {}),
            'rating_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'null': 'True', 'auto_now_add': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'stars'", 'default': 'True', 'on_delete': 'models.DO_NOTHING', 'to': "orm['account.User']"}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
        'warehouse.author': {
