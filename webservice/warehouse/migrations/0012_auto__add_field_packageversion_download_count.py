...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.download_count'
        db.add_column('warehouse_packageversion', 'download_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=9, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersion.download_count'
        db.delete_column('warehouse_packageversion', 'download_count')
