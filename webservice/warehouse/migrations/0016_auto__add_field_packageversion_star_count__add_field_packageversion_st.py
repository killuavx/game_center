...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.stars_count'
        db.add_column('warehouse_packageversion', 'stars_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.stars_sum'
        db.add_column('warehouse_packageversion', 'stars_sum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.stars_average'
        db.add_column('warehouse_packageversion', 'stars_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.stars_good_count'
        db.add_column('warehouse_packageversion', 'stars_good_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.stars_good_rate'
        db.add_column('warehouse_packageversion', 'stars_good_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.stars_medium_count'
        db.add_column('warehouse_packageversion', 'stars_medium_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.stars_medium_rate'
        db.add_column('warehouse_packageversion', 'stars_medium_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.stars_low_count'
        db.add_column('warehouse_packageversion', 'stars_low_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PackageVersion.stars_low_rate'
        db.add_column('warehouse_packageversion', 'stars_low_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersion.stars_count'
        db.delete_column('warehouse_packageversion', 'stars_count')

        # Deleting field 'PackageVersion.stars_sum'
        db.delete_column('warehouse_packageversion', 'stars_sum')

        # Deleting field 'PackageVersion.stars_average'
        db.delete_column('warehouse_packageversion', 'stars_average')

        # Deleting field 'PackageVersion.stars_good_count'
        db.delete_column('warehouse_packageversion', 'stars_good_count')

        # Deleting field 'PackageVersion.stars_good_rate'
        db.delete_column('warehouse_packageversion', 'stars_good_rate')

        # Deleting field 'PackageVersion.stars_medium_count'
        db.delete_column('warehouse_packageversion', 'stars_medium_count')

        # Deleting field 'PackageVersion.stars_medium_rate'
        db.delete_column('warehouse_packageversion', 'stars_medium_rate')

        # Deleting field 'PackageVersion.stars_low_count'
        db.delete_column('warehouse_packageversion', 'stars_low_count')

        # Deleting field 'PackageVersion.stars_low_rate'
        db.delete_column('warehouse_packageversion', 'stars_low_rate')
    ...
    models = {
        ...
        'toolkit.star': {
            ...
            'by_comment': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'unique': 'True', 'related_name': "'content_star'", 'default': 'None', 'to': "orm['generic.ThreadedComment']"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_pk': ('django.db.models.fields.IntegerField', [], {}),
            'rating_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'stars'", 'to': "orm['account.User']"}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
        'warehouse.author': {
