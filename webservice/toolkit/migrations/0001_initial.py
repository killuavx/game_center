...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Star'
        db.create_table('common_star', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('by_comment', self.gf('django.db.models.fields.related.ForeignKey')(null=True, related_name='content_star', default=None, blank=True, on_delete=models.DO_NOTHING, to=orm['generic.ThreadedComment'])),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
            ('rating_date', self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True, auto_now_add=True)),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(null=True, related_name='stars', default=True, blank=True, on_delete=models.DO_NOTHING, to=orm['account.User'])),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(blank=True, null=True, max_length=15)),
        ))
        db.send_create_signal('toolkit', ['Star'])


    def backwards(self, orm):
        # Deleting model 'Star'
        db.delete_table('common_star')
    ...
    models = {
        ...
        'comments.comment': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'comment_comments'", 'to': "orm['account.User']"}),
        ...
        'toolkit.star': {
            ...
            'by_comment': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'content_star'", 'default': 'None', 'blank': 'True', 'on_delete': 'models.DO_NOTHING', 'to': "orm['generic.ThreadedComment']"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'blank': 'True', 'null': 'True', 'max_length': '15'}),
            'object_pk': ('django.db.models.fields.IntegerField', [], {}),
            'rating_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'null': 'True', 'auto_now_add': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'stars'", 'default': 'True', 'blank': 'True', 'on_delete': 'models.DO_NOTHING', 'to': "orm['account.User']"}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        }
    }
