...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.is_hidden'
        db.add_column('taxonomy_topic', 'is_hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Category.is_hidden'
        db.add_column('taxonomy_category', 'is_hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.is_hidden'
        db.delete_column('taxonomy_topic', 'is_hidden')

        # Deleting field 'Category.is_hidden'
        db.delete_column('taxonomy_category', 'is_hidden')
