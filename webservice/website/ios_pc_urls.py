...
urlpatterns = patterns('website.views',
    ...
    url(r'packages/topics/(?P<slug>%s)/$' % slug_pattern, 'iospc_collection_detail_views', name='iospc_masterpiece_packages'),
    url(r'packages/vendors/(?P<slug>%s)/(?:(?P<pk>\d+)/)?$' % slug_pattern, 'iospc_vendors_list_views', name='iospc_vendors_list'),
