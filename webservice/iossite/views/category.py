...
from iossite.views.base import ApiParamFilterBackendViewMixin, ApiSearchPackageViewMixin, pageobj_with_visible_range, PRODUCT
from iossite.views.filters import BaseParamFilterBackend, LanguageParamFilterBackend, PkgSizeParamFilterBackend, PkgReportsParamFilterBackend, PaginatorParamFilterBackend
...
class CategoryView(ApiParamFilterBackendViewMixin,
    ...
    template_name = 'iossite/pages/category/index.haml'
...
class SearchView(CategoryView):
    ...
    template_name = 'iossite/pages/category/search.haml'
