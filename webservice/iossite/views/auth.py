...
from iossite.forms import LoginForm, SignupForm, CaptchaVerifyForm
from iossite.utils import login as auth_login, logout as auth_logout
from iossite.views.base import is_ajax_request, previous_url, next_url, login_redirect


@csrf_exempt
def login(request, template='iossite/accounts/login.html'):
...
@csrf_exempt
def signup(request, template='iossite/accounts/signup.html'):
...
class UserAuthenticatedPanelView(View):
    ...
    template_prefix = 'iossite/accounts'
