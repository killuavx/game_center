...
account_urlpatterns = patterns('iossite.views.auth',
...
comment_urlpatterns = patterns('iossite.views.comment',
...
urlpatterns = patterns('',
                       ...
                       url(r'^captcha/?', 'iossite.views.auth.captcha', name='captcha'),
...
handler404 = "iossite.views.common.page_not_found"
handler500 = "iossite.views.common.server_error"
