...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PackageRankingItem', fields ['ranking', 'package']
        db.create_index('ranking_packagerankingitem', ['ranking_id', 'package_id'])


    def backwards(self, orm):
        # Removing index on 'PackageRankingItem', fields ['ranking', 'package']
        db.delete_index('ranking_packagerankingitem', ['ranking_id', 'package_id'])
    ...
    models = {
        ...
        'ranking.packageranking': {
            'Meta': {'unique_together': "(('site', 'category', 'ranking_type', 'cycle_type'),)", 'ordering': "('site', '_order')", 'object_name': 'PackageRanking', 'index_together': "(('site', 'category'), ('site', 'category', '_order'), ('site', 'category', 'ranking_type'))"},
            '_order': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
