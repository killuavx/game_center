...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('result_sum_activate_product', (
            ...
            ('start_date', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analysis.DateDim'], related_name='+')),
            ('end_date', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analysis.DateDim'], related_name='+')),
            ...
            ('productkey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analysis.ProductKeyDim'], related_name='+')),
        ))
    ...
    models = {
        'analysis.activatefact': {
            'Meta': {'ordering': "('-date',)", 'object_name': 'ActivateFact', 'db_table': "'fact_activate'", 'index_together': "(('device', 'date'), ('package', 'date'), ('device', 'package', 'date'), ('product', 'device'), ('product', 'device', 'package'), ('productkey', 'device'), ('productkey', 'packagekey'), ('productkey', 'device', 'packagekey'))"},
            ...
            'usinglog': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.UsinglogFact']", 'unique': 'True', 'related_name': "'+'"})
        },
        'analysis.activatenewreservefact': {
            'Meta': {'ordering': "('-date',)", 'object_name': 'ActivateNewReserveFact', 'db_table': "'fact_activate_newreserve'", '_ormbases': ['analysis.ActivateFact']},
        ...
        'analysis.downloadbeginfinishfact': {
            'Meta': {'unique_together': "(('start_download', 'end_download'),)", 'object_name': 'DownloadBeginFinishFact', 'db_table': "'fact_downloadbeginfinish'", 'index_together': "(('download_package', 'date'), ('package', 'date'), ('product', 'device', 'package', 'download_package', 'date'), ('product', 'device', 'download_package', 'date'), ('product', 'device', 'package', 'date'))"},
            'date': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DateDim']"}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DeviceDim']"}),
            'device_language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DeviceLanguageDim']"}),
            'device_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DeviceModelDim']"}),
            ...
            'end_download': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DownloadFact']", 'unique': 'True', 'related_name': "'+'"}),
            'hour': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.HourDim']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'package': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.PackageDim']"}),
            'packagekey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.PackageKeyDim']", 'null': 'True', 'blank': 'True'}),
            ...
            'start_download': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DownloadFact']", 'unique': 'True', 'related_name': "'+'"})
        },
        ...
        'analysis.openclosedailyfact': {
            'Meta': {'unique_together': "(('start_usinglog', 'end_usinglog'),)", 'object_name': 'OpenCloseDailyFact', 'db_table': "'fact_openclose_daily'", 'index_together': "(('product', 'date', 'segment'), ('product', 'package', 'date', 'segment'), ('package', 'device', 'date', 'segment'))"},
            'date': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DateDim']"}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DeviceDim']"}),
            'device_language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DeviceLanguageDim']"}),
            'device_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.DeviceModelDim']"}),
            ...
            'duration': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'end_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'end_usinglog': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.UsinglogFact']", 'unique': 'True', 'related_name': "'+'"}),
            'hour': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.HourDim']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'package': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.PackageDim']"}),
            'packagekey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.PackageKeyDim']", 'null': 'True', 'blank': 'True'}),
            ...
            'segment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.UsinglogSegmentDim']"}),
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'start_usinglog': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analysis.UsinglogFact']", 'unique': 'True', 'related_name': "'+'"})
        },
        ...
        'analysis.productkeydim': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'b8f83a8704162d92634307783842637b'", 'max_length': '40', 'unique': 'True'}),
        ...
        'analysis.sumactivatedeviceproductresult': {
            'Meta': {'unique_together': "(('productkey', 'start_date', 'end_date'),)", 'object_name': 'SumActivateDeviceProductResult', 'db_table': "'result_sum_activate_product'", 'index_together': "(('productkey', 'cycle_type', 'end_date'), ('productkey', 'cycle_type', 'start_date'), ('productkey', 'cycle_type', 'start_date', 'end_date'), ('cycle_type', 'start_date', 'end_date'))"},
