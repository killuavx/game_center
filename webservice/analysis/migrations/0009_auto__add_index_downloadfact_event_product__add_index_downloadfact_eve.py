...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SumDownloadProductResult.total_download_count'
        db.add_column('result_sum_download_product', 'total_download_count',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SumDownloadProductResult.total_download_count'
        db.delete_column('result_sum_download_product', 'total_download_count')
    ...
    models = {
        ...
        'analysis.productkeydim': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '40', 'default': "'6a8c0146f331ca04d0717412a85b8594'", 'unique': 'True'}),
